    ...
    <section className='about-me'>
      ...
      <div className='about-me__container'>
        <div className='about-me__description'>
          ...
          в этой сфере: участвую в проектах со своими единомышленниками, создаю собственные проекты для пополнения портфолио, решаю алгоритмические задачи,
          читаю дополнительную литературу. Моя цель - не стабильность, а постоянное развитие своих навыков.</p>
